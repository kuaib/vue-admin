        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="100px">
            ...
            <section>
                <el-row type="flex" class="row-item" justify="space-between">
                    <el-col :span="4">
                        <div class="grid-content title">基本信息</div>
                    </el-col>
                    <el-col :span="3">
                ...
                <el-row>
                    ...
                    <el-col :span="8">
                        <el-form-item label="单据日期" prop="orderDate">
                            <el-date-picker type="date" placeholder="单据日期" v-model="form.orderDate"
                                            style="width: 100%;"></el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="交货日期" prop="subProdDate">
                            <el-date-picker type="date" placeholder="交货日期" v-model="form.subProdDate"
                                            style="width: 100%;"></el-date-picker>
                        </el-form-item>
                    </el-col>
                </el-row>
            ...
            <section>
                <el-row type="flex" class="row-item" justify="space-between">
                    <el-col :span="4">
                        <div class="grid-content title">明细信息</div>
                    </el-col>
