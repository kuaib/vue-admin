...
<template>
    <div class="test-athlete-charts">
        <!--搜索条件-->
        <charts-search @searchAction="formatChartsData" typeName="team"></charts-search>

        <!--图表-->
        <el-row>
            <div style="font-size: 18px;font-weight:700;text-align:center">运动队测试指标变化趋势图</div>
            <div id="teamChart" style="width: 600px;height:400px;margin:0 auto"></div>
        </el-row>
    </div>
</template>
<script>
    ...
    export default {
        ...
        methods: {
            ...
            initEcharts() {
                ...
                this.myChart = echarts.init(document.getElementById('teamChart'));
