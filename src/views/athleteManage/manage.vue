        ...
        <el-col :span="9">
          ...
          <el-row>
            <el-form-item label="队伍" prop="teamId" >
              <el-select v-model="form.teamId" placeholder="请选择队伍" @change="handleChange(form.teamId,'team')">
                <el-option v-for="item in teamList" :label="item.dicValue" :value="item.dicKey" :key="item.dicKey"></el-option>
              </el-select>
              <!--<div>编辑运动员时显示</div>-->
            </el-form-item>
          </el-row>
          ...
          <el-row>
            <el-form-item label="省份" prop="provinceId">
              <el-select v-model="form.provinceId" placeholder="请选择省份" @change="handleChange(form.provinceId,'province')">
                <el-option v-for="item in provinceList" :label="item.dicValue" :value="item.dicKey" :key="item.dicKey"></el-option>
              </el-select>
            </el-form-item>
            <el-row>
          ...
          <el-form-item label="跨项开始时间" prop="crossSince" v-show="form.isCross==1">
            <el-col :span="11" class="chooseDate">
              <el-date-picker type="date" placeholder="选择日期" v-model="form.crossSince" style="width: 100%;"></el-date-picker>
            </el-col>
          </el-form-item>
...
<script>
  import {getAllDic} from '@/api/team'
